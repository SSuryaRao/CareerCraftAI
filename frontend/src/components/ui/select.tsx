...
// Custom Select component (for backward compatibility)
...
export function Select({ options, value, onValueChange, placeholder = "Select an option", className = "", children }: CustomSelectProps) {
  const [isOpen, setIsOpen] = useState(false)

  // Guard against undefined options
  if (!options) {
    console.error('Select component: options prop is undefined')
    return null
  }
...
// Radix UI based Select components (shadcn/ui style)
